import{g as U,s as q,a as K,b as V,t as Z,q as j,_ as s,l as w,c as H,F as J,K as Q,M as X,e as Y,z as ee,G as te}from"./mermaid.core.D4TRxPCZ.js";import{p as ae}from"./chunk-4BX2VUAB.P5ZI--ex.js";import{p as re}from"./treemap-KMMF4GRG.14KYKHkk.js";import"./transform.DJaL91VY.js";import{d as G}from"./arc.gdN8HGu6.js";import{o as ie}from"./ordinal.BYWQX77i.js";import{d as se}from"./pie.Da4ddhkn.js";import"./preload-helper.BlTxHScW.js";import"./_commonjsHelpers.CqkleIqs.js";import"./marked.esm.BSGMMIyL.js";import"./min.DpBFuS1k.js";import"./_baseUniq.Dci7SGTL.js";import"./_getAllKeys.WBz_g9J9.js";import"./init.Gi6I4Gst.js";var oe=te.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,le=structuredClone(oe),ne=s(()=>structuredClone(le),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,ee()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),me=s(()=>C,"getShowData"),M={getConfig:ne,clear:ce,setDiagramTitle:j,getDiagramTitle:Z,setAccTitle:V,getAccTitle:K,setAccDescription:q,getAccDescription:U,addSection:pe,getSections:de,setShowData:ge,getShowData:me},ue=s((e,a)=>{ae(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),fe={parse:s(async e=>{const a=await re("pie",e);w.debug(a),ue(a,M)},"parse")},he=s(e=>`
  .pieCircle{
